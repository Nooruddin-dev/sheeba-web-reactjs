...
export default function ManageSaleInvoicePage() {
    ...
    const handleInvoiceTaxChange = (value: number) => {
        setInvoiceSummary((prevSummary: any) => {
                                                                ...
                                                                <tr key={'line-item-' + index}>
                                                                    ...
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleLineItemChange(index, 'salesTaxPercentage', parseFloat(e.target.value))} />
                                                                    ...
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleLineItemChange(index, 'furtherTaxPercentage', parseFloat(e.target.value))} />
                                                                    ...
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleLineItemChange(index, 'advanceTaxPercentage', parseFloat(e.target.value))} />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input
                                                                ...
                                                                onChange={(e) => handleInvoiceDiscountChange(parseFloat(e.target.value))} />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tax %</td>
                                                        <td>
                                                            <input
                                                                ...
                                                                onChange={(e) => handleInvoiceTaxChange(parseFloat(e.target.value))} />
